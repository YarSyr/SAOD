...
int main()
{
	...
	vector<int> number2;
	vector<int> res;
	string I1("456456945699945654699954654654565499999546999999999999999994546456546456"); //Первая строка
	string I2("567857856999578999567078090809999995678567876899998679999675999999"); //Вторая строка
